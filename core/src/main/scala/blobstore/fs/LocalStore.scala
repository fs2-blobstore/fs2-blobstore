...
//
//final class LocalStore[F[_]](fsroot: NioPath, blocker: Blocker)(implicit F: Concurrent[F], CS: ContextShift[F])
//  extends Store[F] {
...
//
//object LocalStore {
//  def apply[F[_]](fsroot: NioPath, blocker: Blocker)(implicit F: Concurrent[F], CS: ContextShift[F]): LocalStore[F] =
//    new LocalStore(fsroot, blocker)
//}
