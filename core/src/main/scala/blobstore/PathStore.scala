...
abstract class PathStore[F[_], BlobType] {
  ...
  /** Lifts this FileStore to a Store accepting URLs and exposing blobs of type `BlobType`. You may provide a function
    * `g` for controlling input paths to this store.
    *
